...
//
//上线检查 debug_mode、GestureEnable、VSP_JDPUSHDEBUG 配置
...
#define VSP_WINDOW                          [[[UIApplication sharedApplication] delegate] window]
...
#define SafeGetArrayValue(object)       ([object isKindOfClass:[NSArray class]] ? object : nil)
#define SafeGetDateValue(object)        ([object isKindOfClass:[NSDate class]] ? object : nil)
#define SafeGetDictionaryValue(object)  ([object isKindOfClass:[NSDictionary class]] ? object : nil)
